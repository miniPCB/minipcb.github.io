...
Engine Version: 0.2
Generated On: 2026-02-21T22:41:11.871Z
...
| U1 | pin_open | 8 | 6 | 8 | 384 | uncovered |
| U1 | pin_short | 8 | 6 | 8 | 384 | uncovered |
| U1 | pin_short_to_adjecent_pin_up | 8 | 6 | 8 | 384 | uncovered |
| U1 | pin_short_to_adjecent_pin_down | 8 | 6 | 8 | 384 | uncovered |
| U1 | latchup | 8 | 6 | 8 | 384 | uncovered |
| U1 | timing_shift | 8 | 6 | 8 | 384 | uncovered |
| U1 | output_stuck_high | 8 | 6 | 8 | 384 | uncovered |
| U1 | output_stuck_low | 8 | 6 | 8 | 384 | uncovered |
...
| LED1 | open | 8 | 4 | 8 | 256 | uncovered |
| LED1 | short | 8 | 4 | 8 | 256 | uncovered |
| LED1 | inductance_low | 8 | 4 | 8 | 256 | uncovered |
| LED1 | inductance_high | 8 | 4 | 8 | 256 | uncovered |
| LED1 | core_saturation | 8 | 4 | 8 | 256 | uncovered |
...
| TP8 | measurement_error | 8 | 2 | 8 | 128 | uncovered |
| TP8 | probe_slip | 8 | 2 | 8 | 128 | uncovered |
| TP8 | open_test_node | 8 | 2 | 8 | 128 | uncovered |
...
| LED1 | open | Deterministic failure assumption for inductor mode 'open'. | Primary propagation: directly connected nets and bias points shift based on topology. | Secondary propagation: downstream interfaces, margins, and detection paths are impacted. |
| LED1 | short | Deterministic failure assumption for inductor mode 'short'. | Primary propagation: directly connected nets and bias points shift based on topology. | Secondary propagation: downstream interfaces, margins, and detection paths are impacted. |
| LED1 | inductance_low | Deterministic failure assumption for inductor mode 'inductance low'. | Primary propagation: directly connected nets and bias points shift based on topology. | Secondary propagation: downstream interfaces, margins, and detection paths are impacted. |
| LED1 | inductance_high | Deterministic failure assumption for inductor mode 'inductance high'. | Primary propagation: directly connected nets and bias points shift based on topology. | Secondary propagation: downstream interfaces, margins, and detection paths are impacted. |
| LED1 | core_saturation | Deterministic failure assumption for inductor mode 'core saturation'. | Primary propagation: directly connected nets and bias points shift based on topology. | Secondary propagation: downstream interfaces, margins, and detection paths are impacted. |
